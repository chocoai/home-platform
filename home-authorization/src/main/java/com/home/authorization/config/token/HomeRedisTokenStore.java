package com.home.authorization.config.token;
...
/**
 * 重写RedisTokenStore ， 因为spring-boot-starter-data-redis 2.0.1.RELEASE版本弃用了conn.set()
 * conn.set() ->conn.stringCommands().set()
 *
 * @author roger
 * @email 190642964@qq.com
 * @create 2018-07-11 15:22
 **/
public class HomeRedisTokenStore implements TokenStore {
    ...
    public HomeRedisTokenStore(RedisConnectionFactory connectionFactory) {
